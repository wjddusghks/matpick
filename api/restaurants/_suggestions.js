...
const suggestionStore = require("./_suggestionStore");

function createSuggestionHandler(store = suggestionStore) {
  const {
    validateSuggestion,
    saveSuggestion,
    listSuggestions,
...
module.exports = createSuggestionHandler();
module.exports.createSuggestionHandler = createSuggestionHandler;
