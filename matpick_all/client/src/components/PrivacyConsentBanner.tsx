...
export default function PrivacyConsentBanner() {
  ...
  const copy = isEnglish
    ? {
        ...
        body: "Essential storage keeps the service working. Analytics and advertising tools run only after you allow them.",
        details: "Customize",
        ...
        advertisingBody: "Allows AdSense, Kakao AdFit, Coupang Partners, and related measurement.",
        privacy: "Privacy policy",
        close: "Close privacy settings",
      }
    : {
        title: "개인정보 및 쿠키 설정",
        body: "필수 저장소는 서비스 작동에만 사용합니다. 분석 및 광고 도구는 허용한 경우에만 실행됩니다.",
        details: "상세 설정",
        essential: "필수만 사용",
        accept: "모두 허용",
        save: "선택 저장",
        ...
        advertising: "광고",
        advertisingBody: "Google AdSense, 카카오 애드핏, 쿠팡 파트너스와 관련 측정을 허용합니다.",
        privacy: "개인정보처리방침",
        close: "개인정보 설정 닫기",
      };
