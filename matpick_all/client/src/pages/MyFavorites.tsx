...
const MY_FAVORITES_UI = {
  ko: {
    ...
    loginDescription:
      "카카오나 네이버로 로그인하고 찜한 맛집을 모아보세요. 찜 목록은 현재 브라우저에만 저장되며, 다른 기기와 동기화되지 않아요.",
    backHome: "홈으로 돌아가기",
    goBack: "뒤로 가기",
    pageTitle: "저장한 맛집",
    pageDescription: "찜한 맛집을 다시 찾아보세요. 저장 목록은 현재 브라우저에서만 유지돼요.",
    allSavedLabel: "전체 저장",
    topicCountLabel: "내 주제",
    viewAll: "전체 보기",
    plainSaved: "단순 저장",
    emptyTitle: "아직 저장한 맛집이 없어요.",
    emptyDescription: "마음에 드는 식당의 하트를 누르면 여기에 모아볼 수 있어요.",
  ...
  en: {
    ...
    loginDescription:
      "Sign in with Kakao or Naver to save restaurants. Saved places stay in this browser and do not sync across devices.",
    backHome: "Back to home",
    goBack: "Go back",
    pageTitle: "Saved Restaurants",
    pageDescription: "Find your saved restaurants again. Your list is kept in this browser only.",
    allSavedLabel: "All saved",
    topicCountLabel: "My topics",
    viewAll: "View all",
    plainSaved: "Direct saves",
    emptyTitle: "You have not saved any restaurants yet.",
    emptyDescription: "Tap the heart on a restaurant to add it to this list.",
